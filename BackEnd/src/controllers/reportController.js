...
// ลำดับอ่าน 4D: reportRoutes และ Middleware ส่ง request มาที่ไฟล์นี้ | ฟังก์ชันในนี้ตรวจข้อมูล Report → ใช้ prisma → ส่ง JSON กลับ Frontend | ความสัมพันธ์ Report/User/Place ดูต่อได้ใน prisma/schema.prisma
import fs from "fs";
