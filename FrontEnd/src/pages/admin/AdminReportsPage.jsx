...
// โหลดเฉพาะ Report pending แล้วแสดงรายการให้ Admin ตรวจ | กดรายการแล้วเปิด AdminReportDetailPage ตาม id
...
// ประกาศฟังก์ชันนี้และกำหนดขอบเขตงานตามชื่อของฟังก์ชัน
  ...
  useEffect(() => {
  // หน้าแจ้งเตือนแสดงเฉพาะงานที่ยังรอดำเนินการ | เมื่อ resolved/rejected แล้ว รายการจะหายจากหน้านี้
    api
