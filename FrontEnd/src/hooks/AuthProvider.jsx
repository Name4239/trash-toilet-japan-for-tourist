...
// ลำดับอ่าน Frontend 3: จัดการ User, Token, Login และ Logout | เมื่อได้ Token จะเรียก /users/me เพื่อโหลด User จาก Backend
...
// ประกาศฟังก์ชันนี้และกำหนดขอบเขตงานตามชื่อของฟังก์ชัน
  ...
  // สร้างฟังก์ชัน async เพื่อให้ใช้ await กับงาน API หรือ Database ได้
    ...
    // อ่านหรือเขียนข้อมูลที่ต้องคงอยู่ใน Browser หลังรีเฟรชหน้า
    return loadUser();
    // ส่งผลลัพธ์ออกจากฟังก์ชันและหยุดทำบรรทัดถัดไปในฟังก์ชันนี้
  }
